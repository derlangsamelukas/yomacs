...
(custom-set-variables
 ...
 '(elm-compile-command (quote ("/home/lukas/Downloads/extracted/elm" "make")))
 '(elm-interactive-command (quote ("/home/lukas/Downloads/extracted/elm" "repl")))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "unspecified-bg" :foreground "#b8d8e7" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 1 :width normal :foundry "default" :family "default"))))
 '(company-tooltip ((t (:background "color-24" :foreground "#b8d8e7"))))
 '(company-tooltip-common ((t (:inherit company-tooltip :foreground "color-49"))))
 ...
 '(helm-source-header ((t (:background "#2b2b2b" :foreground "#ff1493" :box (:line-width -1 :style released-button) :underline nil :weight bold))))
 '(ivy-current-match ((t (:background "color-233" :foreground "#eb0e69" :weight bold))))
 '(ivy-minibuffer-match-face-1 ((t (:background "color-53"))))
 '(ivy-minibuffer-match-face-2 ((t (:background "color-53" :weight bold))))
 '(ivy-minibuffer-match-face-3 ((t (:background "color-55" :weight bold))))
 '(ivy-minibuffer-match-face-4 ((t (:background "color-54" :weight bold))))
 ...
 '(lazy-highlight ((t (:background "#4c83ff" :foreground "#000000"))))
 '(link ((t (:foreground "#ff1493" :underline t :weight bold))))
 ...
 '(widget-field ((t (:background "#47687F" :foreground "#b8d8e7")))))
